...
@section('content')
    <div class="container my-5">
        <div class="row my-5 justify-content-center align-items-center" style="min-height: 100vh;">
            <div class="col-lg-6">
                <h1>Gokiiw queue management system</h1>
                ...
                <p>
                    ...
                    We are here to help you manage queues of all sizes and shapes. Our system makes it easy to keep lines moving and reduce wait times. 
                    Say goodbye to long lines and hello to shorter wait times. Our queue management system helps you manage customer flow, prioritize customers, and customize your queuing experience. 
                    Let us help you get your queues in order. With our system, you can keep the line moving, cut the wait time, and maximize customer satisfaction. 
                    Don't get stuck in a queue. Contact us today to get started with GoKiiw Queue Management Solutions!
