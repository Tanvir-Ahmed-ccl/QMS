    ...
    <div class="panel-body"> 
        {{ Form::open(['url' => 'admin/user/create', 'files' => true, 'class'=>'col-md-7 col-sm-8']) }}
            ...
            <div class="form-group @error('user_type') has-error @enderror"> 
                ...
                {{ Form::select('user_type', UserRoles()->pluck('name', 'id'), old('user_type'), ['placeholder' => trans('app.select_option'), 'class'=>'select2 form-control', 'id'=>'user_type']) }}<br/>
                <span class="text-danger">{{ $errors->first('user_type') }}</span>
            </div>

            <div class="form-group @error('department_id') has-error @enderror" id="user_department">
            ...
            <div class="form-group @error('mobile') has-error @enderror">
                ...
                <input type="text" name="mobile" id="mobile" class="form-control" placeholder="{{ trans('app.mobile') }}" value="{{ old('mobile') }}" required>
