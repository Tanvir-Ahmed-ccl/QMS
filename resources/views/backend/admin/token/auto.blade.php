    ...
    <div class="panel-heading pt-0 pb-0">
        <ul class="row m-0 list-inline">
            <li class="col-xs-6 col-sm-4 p-0 text-left">
                <img src="{{ asset(session('app.logo')) }}" width="210" height="50">
            </li>  
        ...
        <div class="col-sm-12" id="screen-content">
            @if($display->sms_alert || $display->show_note)
                ...
                <div class="p-1 m-1 btn btn-primary capitalize text-center">
                    <button 
                        onclick="loadRelatedSection('{{ $department->department_id }}', '{{Auth::user()->company_id}}')"
                        type="button" 
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <p><input type="text" name="note" class="form-control" placeholder="{{ trans('Client Name') }}" required><span class="text-danger">The Name field is required!</span></p>
        <p>
            <textarea name="note1" id="note1" class="form-control" placeholder="{{ trans('Note') }}">{{ old('note') }}</textarea>
        </p>
